package cn.edu.zust.dmt.hsy.entrance_module.views.customized;
 ...
 **/
public class em_MyTreeView extends BaseAnimateView {
...
//    private int mTrunkCount = 0;
    ...
    public em_MyTreeView(Context context) {
        this(context, null);
    }

    public em_MyTreeView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public em_MyTreeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            LogUtil.showDebugLog(mDuration + "redraw!");
    ...
    private void initializeViews(@NonNull Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.em_MyTreeView);
        mTreeBaseColor = typedArray.getColor(R.styleable.em_MyTreeView_em_MyTreeViewBaseColor, mTreeBaseColor);
        typedArray.recycle();
